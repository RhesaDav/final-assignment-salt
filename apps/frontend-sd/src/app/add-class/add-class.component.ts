...
export class AddClassComponent implements OnInit {
  ...
  constructor(private  formbBuilder: FormBuilder, private kelasService:KelasServices, private subjectService : SubjectService, private teacherService: TeacherService) { }
